...
public class TelaTarefas extends javax.swing.JFrame {
     ...
     * @param notaService
     */
    public TelaTarefas(Pessoa usuario, PessoaService pessoaService, ForumService forumService, ForumPostService forumPostService, NotaService notaService) {
    ...
    private void btArquivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btArquivarActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Tarefa arquivada. Não se esqueca de enviá-la.");
    ...
    private void btEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviarActionPerformed
        ...
        if (arquivo.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Você deve enviar algum arquivo.");
        } else {
