...
public class TelaCadastro extends javax.swing.JFrame {
     ...
     * @param notaService
     */
    public TelaCadastro(Pessoa usuario, PessoaService pessoaService, ForumService forumService, ForumPostService forumPostService, NotaService notaService) {
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        try {
            boolean ok = pessoaService.registrarAluno(novaPessoa);
        ...
        } catch (HeadlessException | ServiceException e) {
